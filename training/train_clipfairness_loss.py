...
parser.add_argument('--train_datapath', type=str,
                    default='/lab/kirito/data/CNNspot_test/datacsv')
...
parser.add_argument("--model", type=str, default='clip-adapter_small_loss_no_test',
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        for idx, data_dict in enumerate(train_data_loader):
            ...
            for i in range(20):
                ...
                losses = model.get_losses(data_dict, preds1, preds2, i)
