...
if __name__ == '__main__':
    ...
    parser.add_argument("--test_path", type=str,
                        default="/lab/kirito/data/CNNspot_test/test/stylegan2/horse_test.csv")
    parser.add_argument("--input_size", type=int, default=224)
    parser.add_argument("--batch_size", type=int,
                        default=512, help="size of the batches")
    parser.add_argument("--num_out_classes", type=int, default=1)
    parser.add_argument("--checkpoints", type=str,
                        default="/lab/kirito/clip-fairness/training/checkpoints/clip-adapter_test/progan_lr0.001/clip-adapter_test8.pth")
    parser.add_argument("--test_data_name", type=str,
                        default='progan')
    parser.add_argument("--model_structure", type=str, default='clip-adapter_test',
    ...
    if opt.model_structure == 'clip-adapter_test':
        model_class = DETECTOR['CLIP_Adapter_test']
        # print(model_class)
    ...
    f_g1_list =[]  
    label_list_temp = []
    save_path = '/lab/kirito/data/CNNspot_test/test/cyclegan/apple.npz' '''
    total = 0
    running_corrects = 0
