...
parser.add_argument("--model", type=str, default='clip-adapter1_small',
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        for idx, data_dict in enumerate(train_data_loader):
            ...
            for i in range(20):
                ...
                prompt = torch.cat((fake_label,real_label),dim=0)
