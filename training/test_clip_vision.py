...
if __name__ == '__main__':
    ...
    parser.add_argument("--test_path", type=str,
                        default="/lab/kirito/data/CNNspot_test/test/cyclegan/apple_test.csv")
    parser.add_argument("--input_size", type=int, default=224)
    parser.add_argument("--batch_size", type=int,
                        default=64, help="size of the batches")
    parser.add_argument("--num_out_classes", type=int, default=1)
    parser.add_argument("--checkpoints", type=str,
                        default="/lab/kirito/clip-fairness/training/checkpoints/CLIP_Vision_test/progan_lr0.001/CLIP_Vision_test10.pth")
    parser.add_argument("--test_data_name", type=str,
                        default='progan')
    parser.add_argument("--model_structure", type=str, default='CLIP_Vision_test',
    ...
    if opt.model_structure == 'CLIP_Vision_test':
        model_class = DETECTOR['CLIP_Vision_test']
        # print(model_class)
