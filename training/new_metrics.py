...
def acc_fairness(path, attribute_list):
    ...
    for item in dict_data.keys():
        ...
        if totalnumber != 0:
            try:
                ...
                # print(item, metrics[item]['positive_rate'])
                # print(item, metrics[item]['negative_rate'])
    ...
    # print(gap_g1['Fdp_diff'], 'gap_g1[Fdp_diff]')[0.015599779562526006, 0.015599779562525978] gap_g1[Fdp_diff]
    # print(gap_g1['PR'])[0.8466864490603363, 0.8622862286228623]
...
### ff++ ####
acc_fairness('/home/ubuntu/shahur/Final_Misleading/checkpoints/XceptionMis_Newthird_final_Xcept/ff++_XceptionMis_Newthird_final_M2_nons/result/out_res/', [
             ['male', 'nonmale'], ['asian', 'white', 'black', 'others']])
### celebdf #####
# acc_fairness('D:/RA_work/Fairness_YanJu_Code/4012Code/results/',
#              [['male', 'nonmale'], ['white', 'black', 'others']])
### dfd ###
# acc_fairness('/path/to/saved/dfd/predictions.npy(labels.npy)/, [['male', 'nonmale'], ['white', 'black', 'others']])
### dfdc ###
# acc_fairness('path/to/saved/dfdc/predictions.npy(labels.npy)/', [['male', 'nonmale'], ['asian', 'white', 'black', 'others']])
